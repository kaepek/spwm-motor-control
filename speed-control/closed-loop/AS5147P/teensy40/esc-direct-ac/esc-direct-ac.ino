...
kaepek::EscDirectL6234Teensy40AS5147P<ENCODER_DIVISIONS, ENCODER_VALUE_COMPRESSION, PWM_WRITE_RESOLUTION> ESC;
...
void setup()
{
  ...
  ESC = kaepek::EscDirectL6234Teensy40AS5147P<ENCODER_DIVISIONS, ENCODER_VALUE_COMPRESSION, PWM_WRITE_RESOLUTION>(DUTY_CAP, ENC, 3.8, SPWM_PIN_CONFIG, KALMAN_CONFIG, VOLTAGE_MAP, AC_MAP); // 3us (micro) sample period 2.8 2.6
