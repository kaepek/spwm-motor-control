...
void setup()
{
  ...
  ESC = kaepek::PidEscL6234Teensy40AS5147P<ENCODER_DIVISIONS, ENCODER_VALUE_COMPRESSION, PWM_WRITE_RESOLUTION>(DUTY_CAP, ENC, 3.8, MOTOR_CALIBRATION_CONFIG, SPWM_PIN_CONFIG, KALMAN_CONFIG, PID_CONFIG, AC_MAP); // 3us (micro) sample period 2.8 2.6
